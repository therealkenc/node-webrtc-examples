...
tape('WebRtcConnection', (t) => {
  ...
  t.test(
    'connection timer, if fired before .iceConnectionState is "connected" or "completed"',
    (t) => {
      const callbacks = [];
  ...
  t.test(
    'if .iceConnectionState becomes "connected" or "completed" before the connection timer fires',
    (t) => {
      const callbacks = [];
  ...
  t.test(
    'reconnection timer, if fired before .iceConnectionState is "connected" or "completed"',
    (t) => {
      const callbacks = [];
